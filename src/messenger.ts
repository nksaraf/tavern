...
export function makeMessage(
  ...
  if (msg === null) throwTypeError('msg', msg, 'message|string');
  ...
  if (_.isString(msg)) {
    return {
      ...
      payload: Object.assign(
        {},
        checkArgType(payload, 'object', 'payload', {})
      ),
  ...
  if (_.isString(message.type)) {
    return {
      ...
      payload: Object.assign(
        {},
        payload,
        checkArgType(message.payload, 'object', 'message.payload', {})
      ),
      ctx: Object.assign(
        {},
        ctx,
        checkArgType(message.ctx, 'object', 'message.ctx', {})
      )
    };
  }
